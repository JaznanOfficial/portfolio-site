                ...
                <div class="max-width">
                    ...
                    <Row xs={1} md={3} className="g-2 justify-content-center align-items-center">
                        <div className="card project-card m-5" style={{ width: "18rem" }}>
                                ...
                                />
                            <Button className='m-1' variant="outline-dark"><strong>Live Site Link</strong></Button>
                        <Button className='m-1' variant="outline-primary"> <strong>Client Side Code</strong> </Button>
                        <Button className='m-1' variant="outline-success"> <strong>Server Side Code</strong> </Button>
                        </div>
